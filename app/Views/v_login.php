    ...
    <div class="login-box">
        ...
        <div class="login-box-body bg-gray-light" style="border-radius: 10px;">
            ...
            <div class="form-group has-feedback">
                <input type="email" class="form-control" placeholder="Email/Nomor Telepon" name="email" style="border-width: 2px; border-color: cyan; border-radius: 10px;">
            ...
            <div class="social-auth-links text-center">
                ...
                <p>- OR -</p>
                <a href="#" class="btn btn-block btn-flat" style="border-width: 2px; border-color: gray; border-radius: 10px;"><i class="fa fa-google-plus"></i> Continue with Google</a>
                <a href="#" class="btn btn-block   btn-flat" style="border-width: 2px; border-color: gray; border-radius: 10px;"><i class="fa fa-facebook-square"></i> Continue with Facebook</a>
            </div>
            <!-- /.social-auth-links -->
